...
const createpostforuser_dto_1 = require("./dto/createpostforuser.dto");
...
let PostsController = class PostsController {
    ...
    findOne(id) { return this.posts.findOne(id); }
    create(dto) { return this.posts.create(dto); }
    update(id, dto) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, createpostforuser_dto_1.CreatePostForUserDto]),
    __metadata("design:returntype", void 0)
], PostsController.prototype, "createForUser", null);
